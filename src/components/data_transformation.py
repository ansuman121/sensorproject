...
class DataTransformationConfig :
    ...
    transforemed_object_file_path = os.path.join(artifact_dir,'preprocessor.pkl')

class DataTransformatin:
    ...
    def get_data_transformer_object(self):
        ...
        try :
            imputer_step = ('imputer',SimpleImputer(strategy='constan',fill_value=0))
    ...
    def initiate_data_transformation(self):
        ...
        try:
            ...
            preprocessor_path = self.data_transformation_config.transforemed_object_file_path

            os.makedirs(os.pard.dirname(preprocessor_path),exist_ok=True)
